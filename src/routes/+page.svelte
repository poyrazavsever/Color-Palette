  ...
  >
    <div class="flex py-32 px-6 md:p-0 flex-col md:flex-row items-start md:items-center justify-around gap-8 z-10 container">
      <div class="w-full md:w-1/2 flex flex-col items-start gap-4">
        <h2 class="text-xl md:text-5xl text-violet-200 font-black">
          Create new color palette
        </h2>
        <p class="text-lg md:text-2xl text-white font-semibold">
          Here you can create random palettes and save them. This way you can work with palettes that have never been used before. Only save the ones you like!
        </p>
        <button
          on:click={() => generateColors(4)}
      ...
      <div class="w-full md:w-1/2 flex items-center gap-8 flex-wrap">
    ...
    <div class="w-96 h-96 bg-violet-600 absolute left-1/2 rounded-full blur-3xl opacity-10"></div>
  </main>
